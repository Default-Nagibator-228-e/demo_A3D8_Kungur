	...
	public class BitmapTextureResource extends TextureResource {
		...
		override public function upload(context3D:Context3D):void {
			...
			if (data != null) {
				...
				_texture = context3D.createTexture(source.width, source.height, Context3DTextureFormat.BGRA, true);
		 ...
		 * @private 
		 */
		static public function createMips(texture:Texture, bitmapData:BitmapData):void {
			rect.width = bitmapData.width;
			rect.height = bitmapData.height;
			var level:int = 1;
			var bmp:BitmapData = new BitmapData(rect.width, rect.height, bitmapData.transparent);
